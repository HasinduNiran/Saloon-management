...
const CreateSuppliers = () => {
  ...
  // Event handler for saving the Suuplier
  const handleSaveSuuplier = () => {
    ...
    // Making a POST request to save the Suuplier data
    axios
  ...
  // JSX for rendering the create Suuplier form
  return (
    <div className="p-4">
      <BackButton destination='/suppliers/allSupplier'/>
      <h1 className="text-3xl my-4">Create Suuplier</h1>
      {loading ? <Spinner /> : ''}
      <div className="flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto">
        ...
        <button className='p-2 bg-sky-300 m-8' onClick={handleSaveSuuplier}>
          Save
        </button>
      </div>
    </div>
