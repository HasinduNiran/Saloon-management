...
const Home = () => {
  ...
  return (
    ...
    <div className="min-h-screen text-white flex flex-col items-center">
      ...
      <div className="fixed top-0 left-0 right-0 bg-gray-200 text-gray-600 z-50 hidden md:flex justify-center">
      <a href="" className="flex items-center space-x-3 rtl:space-x-reverse">
        <img 
        src={Logo} 
        alt="logo" 
        style={{ width: '30px', height: '30px', borderRadius: '50%', marginLeft : '-350%' }} 
      />
